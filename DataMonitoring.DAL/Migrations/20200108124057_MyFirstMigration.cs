        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleFontSize = table.Column<int>(nullable: false),
                    TitleColorName = table.Column<string>(maxLength: 50, nullable: false),
                    RefreshTime = table.Column<int>(nullable: false),
                    Type = table.Column<int>(nullable: false),
                    TimeManagementId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Group4 = table.Column<string>(nullable: true),
                    Group5 = table.Column<string>(nullable: true),
                    AxeYIsAutoAdjustableAccordingMinValue = table.Column<bool>(nullable: true),
                    AxeYOffsetFromMinValue = table.Column<int>(nullable: true),
                    ...
                    GaugeTargetColor = table.Column<string>(maxLength: 50, nullable: true),
                    GaugeRange1Color = table.Column<string>(maxLength: 50, nullable: true),
                    GaugeRange1MinValue = table.Column<decimal>(nullable: true),
                    GaugeRange1MaxValue = table.Column<decimal>(nullable: true),
                    GaugeRange2Displayed = table.Column<bool>(nullable: true),
                    GaugeRange2Color = table.Column<string>(maxLength: 50, nullable: true),
                    GaugeRange2MinValue = table.Column<decimal>(nullable: true),
                    GaugeRange2MaxValue = table.Column<decimal>(nullable: true),
                    GaugeRange3Displayed = table.Column<bool>(nullable: true),
                    GaugeRange3Color = table.Column<string>(maxLength: 50, nullable: true),
                    GaugeRange3MinValue = table.Column<decimal>(nullable: true),
                    GaugeRange3MaxValue = table.Column<decimal>(nullable: true),
