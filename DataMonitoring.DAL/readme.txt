...
2. Sélectionner le projet DataMonitoring.DAL (dans la fenêtre console le "Default project:")
...
3. Dans la console exécutez la commande : Add-Migration Nom_de_la_migration. Création du script de migration YYYYMMDDhhmmss_Nom_de_la_migration (dans DataMonitoring.DAL\Migrations\).
